...
public class UpgradVersionOfScheduler {
    public static void main(String[] args) {
        // Creating schdules with starting times and end times
        Schedule schedule1 = new Schedule(1,2);
        Schedule schedule2 = new Schedule(1,8);
        Schedule schedule3 = new Schedule(2,5);
        Schedule schedule4 = new Schedule(3,4);
        Schedule schedule5 = new Schedule(5,8);
        Schedule schedule6 = new Schedule(6,7);
